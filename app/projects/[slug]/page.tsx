            ...
            <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm overflow-hidden">
              <div className="relative h-48 sm:h-64 md:h-80 w-full">
                ...
                <div className="absolute bottom-0 left-0 p-4 sm:p-6">
                  <div className="text-xs sm:text-sm text-[#3AB09E] mb-1 sm:mb-2">{project.category}</div>
                    ...
                    <div className="flex flex-wrap gap-2 sm:gap-3 mt-6 sm:mt-8">
                      {project.liveUrl && (
                        <Button
                          asChild
                          size="sm"
                          className="bg-gradient-to-r from-[#006D6F] to-[#1CA9C9] hover:from-cyan-600 hover:to-blue-600 text-xs sm:text-sm"
                        >
                        ...
                        <AnimatedSection key={index} animation="fade-up" delay={100 * (index + 1)}>
                          <Link href={`/projects/${related.slug}`} className="block group">
                            <div className="flex items-center gap-2 sm:gap-3">
                              ...
                              <div>
                                <h3 className="text-sm sm:text-base font-medium group-hover:text-[#3AB09E] transition-colors">
                                  {related.title}
                                </h3>
