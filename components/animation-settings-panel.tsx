...
export function AnimationSettingsPanel() {
  ...
  const presetOptions: { value: AnimationPreset; label: string; icon: React.ReactNode }[] = [
    ...
    { value: "moderate", label: "Moderate", icon: <span className="text-[#3AB09E]">●</span> },
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50">
      ...
      >
        <Settings className="h-5 w-5 text-[#3AB09E]" />
      </Button>
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm font-medium flex items-center">
                <Zap className="w-4 h-4 mr-2 text-[#3AB09E]" />
                Animation Settings
              </h3>
              <Button
                size="icon"
      ...
      <div className="h-20 bg-zinc-800/50 rounded-md overflow-hidden">
        ...
        >
          <div className="text-xs text-center">
            <div className="text-[#3AB09E] mb-1">
              {animationType
                .split("-")
