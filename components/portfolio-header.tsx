    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center group">
          <div className="text-transparent bg-clip-text bg-gradient-to-r from-[#006D6F] to-[#1CA9C9]  font-bold text-xl relative overflow-hidden transition-transform duration-300 group-hover:scale-105">
            {personalInfo.name}
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#006D6F] to-[#1CA9C9]  transition-all duration-300 group-hover:w-full"></span>
          </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "text-[#3AB09E]" : "text-zinc-400 hover:text-white",
                )}
              >
                ...
                <span
                  className={cn(
                    "absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-[#006D6F] to-[#1CA9C9]  transition-all duration-300 group-hover:w-4/5",
                    isActive && "w-4/5",
                  )}
                ></span>
              </Link>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "text-[#3AB09E] border-cyan-400/30" : "text-zinc-300 hover:text-white hover:pl-5",
                )}
