  ...
  if (isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center p-6">
        <div className="w-16 h-16 mb-4 rounded-full bg-gradient-to-r from-[#006D6F] to-[#1CA9C9] flex items-center justify-center">
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Button
          type="submit"
          className="w-full bg-gradient-to-r from-[#006D6F] to-[#1CA9C9] hover:from-cyan-600 hover:to-blue-600"
