        ...
        <div className="bg-gradient-to-r from-zinc-800/50 to-zinc-900/50 p-4 sm:p-6 flex flex-col items-center border-b border-zinc-800">
          <div className="flex flex-col sm:flex-col items-center w-full">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[#3AB09E] mb-1">{personalInfo.title}</p>
          ...
          <TabsContent value="about" className="p-4 sm:p-6 space-y-4 sm:space-y-6 focus:outline-none">
            <div className="space-y-3">
              <h3 className="text-sm font-medium text-zinc-400 flex items-center">
                <User className="w-4 h-4 mr-2 text-[#3AB09E]" />
                About Me
              </h3>
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-medium text-zinc-400 flex items-center">
                <Briefcase className="w-4 h-4 mr-2 text-[#3AB09E]" />
                Professional Focus
              </h3>
              <div className="space-y-2">
                {aboutInfo.focus.map((item, index) => (
                  <div key={index} className="flex items-start">
                    <span className="text-[#3AB09E] mr-2">•</span>
            ...
            <div className="space-y-3">
              <h3 className="text-sm font-medium text-zinc-400 flex items-center">
                <Languages className="w-4 h-4 mr-2 text-[#3AB09E]" />
                Languages
              </h3>
              <div className="space-y-3">
                {aboutInfo.languages.map((language, index) => (
                  <div key={index} className="space-y-1">
                    ...
                    <div className="h-1.5 bg-zinc-800 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-[#006D6F] to-[#1CA9C9] rounded-full"
          ...
          <TabsContent value="contact" className="p-4 sm:p-6 space-y-4 focus:outline-none">
            <div className="space-y-4">
              <div className="flex items-start">
                <Mail className="w-5 h-5 mr-3 text-[#3AB09E] mt-0.5" />
                <div>
                  <h4 className="font-medium">Email</h4>
                  <a
                    href={`mailto:${personalInfo.email}`}
                    className="text-sm text-zinc-400 hover:text-[#3AB09E] transition-colors break-all"
                  >
                    {personalInfo.email}
                  </a>
                </div>
              ...
              <div className="flex items-start">
                <Phone className="w-5 h-5 mr-3 text-[#3AB09E] mt-0.5" />
                <div>
                  <h4 className="font-medium">Phone</h4>
                  <a
                    href={`tel:${personalInfo.phone}`}
                    className="text-sm text-zinc-400 hover:text-[#3AB09E] transition-colors"
                  >
                    {personalInfo.phone}
                  </a>
                </div>
              ...
              <div className="flex items-start">
                <MapPin className="w-5 h-5 mr-3 text-[#3AB09E] mt-0.5" />
                <div>
              ...
              <div className="flex items-start">
                <Clock className="w-5 h-5 mr-3 text-[#3AB09E] mt-0.5" />
                <div>
